...
// Validate ../../app/api/upload-to-tg/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/upload-to-tg">> = Specific
  const handler = {} as typeof import("../../app/api/upload-to-tg/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
